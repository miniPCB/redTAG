...
def setup_tabs(root):
    ...
    tk.Label(trends_tab, text="Trending functionality coming soon...", font=("Arial", 14)).pack(pady=20)
    ...
    add_message_button = tk.Button(messages_subtab, text="Add Custom Message", command=apply_selected_red_tag_message)
